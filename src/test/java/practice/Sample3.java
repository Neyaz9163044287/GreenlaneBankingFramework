...
public class Sample3 		//Fetch product names along with the price displayed in the page of www.flipkart.com
{
	public static void main(String[] args) throws InterruptedException 
	{
		...
		// Locating Search-bar and SendKeys
		...
		for (int i = 0; i <= (priceCount - 1); i++) 
		{
			...
			System.out.println("Product " + (i + 1) + ":" + product.getText() + "-------------------------------->"+ price.getText());
			printed++;
		}
